...
<html>
    <head>
        ...
        <title>Social Market | Edit Address</title>
                            ...
                            <div class="form-horizontal" style="text-align: center">                               
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" name="addid" value="${find.address_Id}">
                                        <textarea class="form-control" name="address" rows="3" required>${find.address}</textarea> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="provice">
                                            <option value="${find.provice}" selected>${find.provice}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" value="${find.canton}" name="canton" required>
                                    </div>
                                </div>
                                <div class="form-group">
