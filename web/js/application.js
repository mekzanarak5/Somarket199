...
(function($) {
  ...
  $(function() {
    ...
    $("select[name='shipaddr']").selectpicker({style: 'btn-primary', menuStyle: 'dropdown-inverse'});
    $("select[name='bankid']").selectpicker({style: 'btn-primary', menuStyle: 'dropdown-inverse'});
