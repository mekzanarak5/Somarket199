            ...
            <div class="col-md-12" align="center">
                ...
                <div class="col-md-6">
                    <a href="#" class="list-group-item active">
                        <h6 class="list-group-item-heading">Price 19,999</h6>
                    </a>
             ...
             <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" placeholder="Name of product" name="name" value="Iphone 5S สีดำ" disabled="disabled">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Description</label>
                            <div class="col-sm-7">
                                <textarea class="form-control" name="des" rows="3" disabled>Iphone 5S สภาพดีมีประกัน</textarea> 
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <a href="" class="btn btn-default active">Black</a>
                                <a href="" class="btn btn-default">White</a>
                                <a href="" class="btn btn-default">Gold</a>
                            </div>
                        </div>
